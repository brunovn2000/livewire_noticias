            ...
            <div class="w-full h-100">
                ...
                <form class="mt-6" wire:submit.prevent="cadastro">
                    <div>
                        ...
                        <input type="text" name="" id="" wire:model="nome"
                    ...
                    <div>
                        ...
                        <input type="email" name="" id="" wire:model="email"
                    ...
                    <div class="mt-4">
                        ...
                        <input type="password" wire:model="password" name="" id=""
                    ...
                    <div class="text-left mt-2">
                        <a href="{{ url('/login') }}"
                            class="text-sm font-semibold text-gray-700 hover:text-blue-700 focus:text-blue-700">Login</a>
                    </div>
