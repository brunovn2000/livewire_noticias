...
<div class="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 gap-10">
        ...
        <div
            ...
            <div class="p-4 pt-0 ">
                <div class="mb-8">
                    <a href="#" class="text-gray-900 font-bold text-lg mb-2 hover:text-indigo-600 inline-block">{{ $noticia->titulo }}</a>
                </div>
                <div class="mb-4">
                ...
                <div class="flex items-center pt-0">
                    ...
                    <div class="text-sm">
                        <a href="#" class="text-gray-900 font-semibold leading-none hover:text-indigo-600">criador:{{ $noticia->user->name }}
                            </a>
