<div>
    <section class="flex flex-col md:flex-row h-screen items-center">
        ...
        <div class="bg-indigo-600 hidden lg:block w-full md:w-1/2 xl:w-2/3 h-screen">
            <img src="https://neilpatel.com/wp-content/uploads/2019/06/maos-masculinas-teclando-em-laptop-em-mesa-de-escr.jpeg"
            ...
            <div class="w-full h-100">
                ...
                <form class="mt-6" wire:submit.prevent="logar">
                    ...
                    <div class="text-right mt-2">
                        <a href="#"
                            class="text-sm font-semibold text-gray-700 hover:text-blue-700 focus:text-blue-700">Esqueci
                            minha senha</a>
                    </div>
                ...
                <p class="mt-8">Não possui conta? <a href="{{ url('/cadastro') }}"
                        class="text-blue-500 hover:text-blue-700 font-semibold">Cria sua conta aqui</a></p>
